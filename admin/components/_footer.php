<footer class="footer position-fixed fixed-bottom" style="left: 244px;">
  <div class="d-sm-flex justify-content-center justify-content-sm-between">
    <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © compucenter.com.pe
      2023
    </span>
...
<script src="<?php echo $src ?>js/hoverable-collapse.js"></script>
<script src="<?php echo $src ?>js/off-canvas.js"></script>
<script src="<?php echo $src ?>js/misc.js"></script>
<!-- Plugin Chart Js -->
<script src="<?php echo $src ?>assets/libraries/chart.js/Chart.min.js"></script>
...
<!-- Custom Js -->
<script src="<?php echo $src ?>js/file-upload.js"></script>
<script src="<?php echo $src ?>js/ajax-backend.js"></script>